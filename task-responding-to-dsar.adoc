...
NOTE: Die DSAR-Funktionen stehen nur zur Verfügung, wenn Sie sich für eine vollständige Klassifizierungsprüfung Ihrer Datenquellen entschieden haben. Datenquellen, bei denen ein Scan nur für die Zuordnung durchgeführt wurde, bieten keine Details auf Dateiebene.


NOTE: NetApp kann keine Garantie für 100 % der Genauigkeit persönlicher Daten und sensibler personenbezogener Daten, die Cloud Data Sense identifiziert. Überprüfen Sie die Informationen immer, indem Sie die Daten überprüfen.
